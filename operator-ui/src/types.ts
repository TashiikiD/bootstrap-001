...
export interface ObservatoryData {
  ...
  cycleRunAudits: Array<{ runId: string; sessionPath: string; sessionLabel: string; startedAt: string | null; finishedAt: string | null; status: string; triggerSource: string; promptSummary: string; relatedCycleId: string | null; relatedChangeId: string | null; auditStatus: string; auditVerification: string; loopId: string | null; loopReportPath: string | null; hasDurableLoopReport: boolean; auditSummary: string; auditFailure: string | null; guidanceOutcomeStatus: string; guidanceOutcomeSummary: string; guidanceOutcomeReportPath: string | null; hasDurableGuidanceOutcomeReport: boolean; guidanceEffectivenessVerdict: string | null; guidanceEffectivenessSummary: string; guidanceEffectivenessReportPath: string | null; hasDurableGuidanceEffectivenessReport: boolean; guidanceLearningReviewSummary: string; guidanceLearningReviewReportPath: string | null; hasDurableGuidanceLearningReviewReport: boolean; guidanceExperimentReviewStatus: string | null; guidanceExperimentReviewSignal: string | null; guidanceExperimentReviewSummary: string; guidanceExperimentReviewReportPath: string | null; hasDurableGuidanceExperimentReviewReport: boolean; guidanceExperimentDecisionType: string | null; guidanceExperimentDecisionPosture: string | null; guidanceExperimentDecisionSummary: string; guidanceExperimentDecisionReportPath: string | null; hasDurableGuidanceExperimentDecisionReport: boolean; guidanceExperimentType: string | null; guidanceExperimentSummary: string; guidanceExperimentReportPath: string | null; hasDurableGuidanceExperimentReport: boolean }>;
