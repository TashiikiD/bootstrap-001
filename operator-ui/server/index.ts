  ...
  const panels = {
    cycleRunner: panel(
      ...
      [
        ...
        `guidanceAdapt=${cycleRunner?.guidanceAdaptationStatus ?? (cycleRunner?.auditGuidance?.adaptationStatus ?? "none")}`,
        `guidanceAdaptReport=${cycleRunner?.guidanceAdaptationReportPath ?? "none"}`,
