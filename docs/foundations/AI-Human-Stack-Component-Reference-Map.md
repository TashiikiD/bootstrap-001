> Repo-local reference copy imported for AIES bootstrap grounding.
> Treat this file as a stable human-authored source; operational derivatives live in `memory/knowledge/`.
